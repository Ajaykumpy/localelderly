                    ...
                    <form class="form-valide" action="{{route('admin.subcategory.update',$subcategory->id)}}" method="Post" enctype="multipart/form-data">
                        ...
                        <div class="form-row row">
                                            ...
                                            <div class="col-md-6 col-xl-6 col-xxl-6 mb-3 form-group">                                            
                                                    <label>Name of Instructor<span class="text-danger">*</span></label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" id="name_of_instructor" name="name_of_instructor" required value="{{$subcategory->name_of_instructor}}">
                                                    </div>
                                            </div>
                                           {{-- <div class="col-md-4 col-xl-4 col-xxl-4 mb-3 form-group">
                                                <label>Price<span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-4 col-xl-4 col-xxl-4 form-group">
                                                <label>Price<span class="text-danger">*</span></label>
                                                <div class="input-group">
                                                <span class="input-group-text"><i class="fa fa-rupee-sign"></i></span>
                                                  <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control" id="price" name="price" required value="{{$subcategory->price}}">
                                                </div>
                                             </div>
                                            <div class="col-md-4 col-xl-4 col-xxl-4 mb-3 form-group">
                                                <label>Discounte Price<span class="text-danger">*</span></label>
                                                <div class="input-group">
                                                <span class="input-group-text"><i class="fa fa-rupee-sign"></i></span>
                                                <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control" id="discounted_price" name="discounted_price" required value="{{$subcategory->price}}">
                                            ...
                                            <div class="col-md-4 col-xl-4 col-xxl-4 mb-3 form-group ">
                                                ...
                                                <div class="input-group">
                                                <span class="input-group-text"><i class="fa fa-hour-sign"></i></span>
                                                    <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control" id="duration" name="duration" required value="{{$subcategory->duration}}">
                                                </div>
                                            </div>
