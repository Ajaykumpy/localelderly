        ...
        <div class="row align-items-center">
            <div class="col-md-12 d-flex justify-content-end">
               ...
               {{--   <a href="{{route('admin.package.create')}}" data-bs-toggle="modal" data-bs-target="#addModal"
                ...
                <a href="{{route('admin.program.create')}}" class="btn btn-success btn-add"><i class="feather-plus-square me-1"></i> Add New</a>
            </div>
        </div>
    </div>
       ...
       $(document).ready(function() {
        $('#table').DataTable({
            ...
            "columns": [
                ...
                { "data": "name_of_instructor","name":"name_of_instructor"},
