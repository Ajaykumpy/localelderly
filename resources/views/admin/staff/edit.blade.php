...
<div class="content container-fluid">
    ...
    <div class="row">
                <div class="col-md-12">@extends('admin.layouts.default')
                    @section('title')
                    Admin - Staff Create
                    @endsection
                    @section('content')
                        ...
                        <div class="row">
                                        <div class="col-md-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <form class="form-valide" action="{{route('admin.staff.update',$instructor->id)}}" method="Post" enctype="multipart/form-data">
                                                    @csrf
                                                        ...
                                                        <div class="col-md-6 col-xl-6 col-xxl-6 mb-3 form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="mobile" class="form-control" onkeypress="this.value = this.value.replace(/[^0-9]/g, '')" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-xl-6 col-xxl-6 mb-3 form-group">
