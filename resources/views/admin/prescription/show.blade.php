    ...
    <div class="row">
        <div class="col-md-8">
            <div class="prescription-info">
                <h4>Prescription Detail  <a class="btn btn-sm text-danger" href="{{route('admin.prescription.pdf',$prescription->prescription_id)}}" target="_blank"><i class="fa fa-file-pdf"></i> Download</a> <a href="#" onclick="window.history.go(-1);" class="btn btn-sm float-end">Back</a></h4>
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="pro-title mb-0">Weight : {{$prescription->weight}} KG </h6>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="pro-title mb-0">Height : {{$prescription->patient->height??'NA'}} feet </h6>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="pro-title mb-0 pb-0">Diagnosis</h6>
                        <p>{!! $prescription->diagnosis !!}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="pro-title mb-0 pb-0 mt-2">Details</h6>
