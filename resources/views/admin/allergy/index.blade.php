    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-md-12 d-flex justify-content-end">
             <div class="doc-badge me-3">Allergy <span class="ms-1">{{$count}}</span></div>
               {{--   <a href="{{route('admin.allergy.create')}}" data-bs-toggle="modal" data-bs-target="#addModal"
                    class="btn btn-succes btn-add"><i class="feather-plus-square me-1"></i> Add New</a> --}}
                <a href="{{route('admin.allergy.create')}}" class="btn btn-success btn-add"><i class="feather-plus-square me-1"></i> Add New</a>
            </div>
        </div>
    </div>
    ...
    function pack_del(id){
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
                type:'post',
                url:'{!! route("admin.allergy.destroy",'+id+') !!}',
