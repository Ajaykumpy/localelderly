...
{{--<div class="row">
    ...
    <a class="btn btn-lg btn-primary" href="{{route('category.create')}}">ADD</a>
    </div>
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-md-12 d-flex justify-content-end">
                <div class="doc-badge me-3">Sub Categrory <span class="ms-1">{{$count}}</span></div>
               {{--   <a href="{{route('admin.package.create')}}" data-bs-toggle="modal" data-bs-target="#addModal"
                ...
                <a href="{{route('admin.subcategory.create')}}" class="btn btn-success btn-add"><i class="feather-plus-square me-1"></i> Add New</a>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h5 class="card-title"> Sub Categrory</h5>
                        </div>
                ...
                <div class="card-body p-0">
                   ...
                   {{--      @foreach ($subcategory as $data)
                                ...
                                <td>{{$data->id}}</td>
                                <td><img src="{{$data->image}}" alt="image" width="200px" height="150px"></td>
                                <td>{{$data->description}}</td>
                                <td>{{$data->price}}</td>
                         
                                <td>{{$data->discounted_price}}</td>
                                <td>{{$data->duration}}</td>
                                <td>{{$data->name_of_instructor}}</td>
                                <td></td>
