    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-md-12 d-flex justify-content-end">
             <div class="doc-badge me-3">Batches  <span class="ms-1">{{$count}}</span></div>
            ...
            <a href="{{route('admin.batches.create')}}" class="btn btn-success btn-add"><i class="feather-plus-square me-1"></i> Add New</a>
            </div>
        </div>
    </div>
    ...
    function pack_del(id){
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
                type:'post',
                url:'{!! route("admin.batches.destroy",'+id+') !!}',
