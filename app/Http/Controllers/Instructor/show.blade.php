                            ...
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            @php $date="";
                                                            if($user->age){
                                                                $date= Carbon\Carbon::createFromFormat('d/m/Y', $user->age)->format('Y-m-d');
                                                            }
                                                               @endphp
                                                            <p>{{ \Carbon\Carbon::parse($date)->age}}</p>
                                                        </div>
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <h5>Address</h5>
                                                    <p>{{$user->room_no}},{{$user->street_name}},{{$user->location}}</p>
                                                </div>
                                ...
                                <div class="col-md-6">
									...
									<div class="col-md-6 card flex-fills">
										<img alt="Card Image" src="{{($items->package && $items->package->image!=null)?url($items->package->image):''}}" class="card-img-top img-fluid">
										<div class="card-header">
										<h5 class="card-title mb-0">{{\App\Models\Package::find($items->package_id)->name??''}}</h5>
										</div>
